...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('draco_infusion', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle(' NNAAPAAAPAANN ', ' NN         NN ', '  V         V  ','               ','               ','   T  GGG  T   ','               ','    T     T    ','               ','     TTTTT     ','       V       ','       V       ','               ','  T         T  ','               ','T     U U     T','     U   U     ','       5       ','     U   U     ','      U U      ','               ')
            .aisle(' FHAAAAAAAAAHF ', ' NN         NN ', ' NV         VN ','               ','               ','   T GGGGG T   ','               ','    T GGG T    ','               ','     T   T     ','               ','      TTT      ','               ','  T         T  ','       U       ','T    U   U    T','      V V      ','    U     U    ','      V V      ','     U   U     ','       U       ')
            .aisle(' FHHHAAAAAHHHF ', ' 3H    N    H4 ', ' NH    N    HN ','  V    0    V  ','  V         V  ','  VT GGGGG TV  ','   V       V   ','   VT GGG TV   ','    V     V    ','    VT G TV    ','     V   V     ','     VT TV     ','   VV     VV   ','  T    G    T  ',' V    U U    V ','T      N      T','    U     U    ','     1 C 2     ','    U     U    ','       I       ','      U U      ')
            .aisle(' FHAAAAAAAAAHF ', ' NN         NN ', ' NV         VN ','               ','               ','   T GGGGG T   ','               ','    T GGG T    ','               ','     T   T     ','               ','      TTT      ','               ','  T         T  ','       U       ','T    U   U    T','      V V      ','    U     U    ','      V V      ','     U   U     ','       U       ')
            .aisle(' NNAAPAAAPAANN ', ' NN         NN ', '  V         V  ','               ','               ','   T  GGG  T   ','               ','    T     T    ','               ','     TTTTT     ','       V       ','       V       ','               ','  T         T  ','               ','T     U U     T','     U   U     ','       6       ','     U   U     ','      U U      ','               ')
            .aisle('  NMAAAHAAAMN  ', '  NM       MN  ', '   M       M   ','               ','               ','    T     T    ','               ','     TTTTT     ','       V       ','       V       ','               ','               ','       V       ','   T       T   ','               ',' T           T ','       U       ','      U U      ','       U       ','               ','               ')
            .aisle('   MMAAHAAMM   ', '   MM     MM   ', '   MM     MM   ','               ','               ','     TTTTT     ','       V       ','       V       ','               ','               ','               ','               ','       V       ','   TT     TT   ','               ',' T           T ','               ','               ','               ','               ','               ')
            .aisle('    NNHHHNN    ', '    NNNHNNN    ', '     VVHVV     ','       V       ','       V       ','       V       ','               ','               ','               ','               ','               ','               ','               ','     TTTTT     ','               ','  T         T  ','               ','               ','               ','               ','               ')
