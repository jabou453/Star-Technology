ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        .mixer(id('duralumin'))
        .itemInputs(
            '4x gtceu:aluminium_dust',
            '3x gtceu:copper_dust',
            '1x gtceu:magnesium_dust',
    ...
    event.recipes.gtceu
        .mixer(id('beryllium_aluminium_alloy'))
