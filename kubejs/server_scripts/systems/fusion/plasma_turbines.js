ServerEvents.recipes((event) => {
    ...
    // Controllers
    event.recipes.gtceu
        .assembly_line(id('supreme_plasma_turbine'))
        .itemInputs(
            'gtceu:uhv_machine_hull',
            '6x gtceu:dense_enriched_naquadah_plate',
            '4x gtceu:neutronium_gear',
            '6x gtceu:small_naquadah_alloy_gear',
            '8x gtceu:enriched_naquadah_huge_fluid_pipe',
            '6x #gtceu:circuits/uhv',
            '64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire',
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:chaotixic_alloy_gear',
            '6x gtceu:small_nyanium_gear',
            '8x gtceu:nyanium_huge_fluid_pipe',
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:small_tungsten_steel_gear',
            'gtceu:tungsten_steel_ring'
        )
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:small_rhodium_plated_palladium_gear',
            '6x gtceu:hsss_round',
            'gtceu:rhodium_plated_palladium_ring'
        )
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:small_osthendah_gear',
            '6x gtceu:osmiridium_round',
            'gtceu:osthendah_ring',
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:tritan_steel_gear',
            '2x gtceu:uv_electric_motor',
            '4x gtceu:small_darmstadtium_gear',
            '6x gtceu:tritan_steel_round',
            'gtceu:darmstadtium_ring',
            '#gtceu:circuits/uv',
            '8x gtceu:fine_americium_wire'
        )
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            'gtceu:uhv_machine_hull',
            '4x gtceu:zalloy_gear',
            '2x gtceu:uhv_electric_motor',
            '6x gtceu:small_neutronium_gear',
            '8x gtceu:zircalloy_4_round',
            'gtceu:neutronium_ring',
            '2x kubejs:uhv_transmission_assembly',
            '#gtceu:circuits/uhv',
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            ...
            '4x gtceu:starium_alloy_gear',
            '2x gtceu:uev_electric_motor',
            '6x gtceu:small_mythrolic_alloy_gear',
            '8x gtceu:magmada_alloy_round',
            'gtceu:mythrolic_alloy_ring',
            '2x kubejs:uev_transmission_assembly',
            'kubejs:uev_precision_drive_mechanism',
            '#gtceu:circuits/uev',
            '12x gtceu:fine_adamantine_wire'
        )
    ...
    event.recipes.gtceu
        ...
        .itemInputs(
            'gtceu:uiv_machine_hull',
            '4x gtceu:ohmderblux_alloy_gear',
            '2x gtceu:uiv_electric_motor',
            '6x gtceu:small_chaotixic_alloy_gear',
            '8x gtceu:abyssal_alloy_round',
            'gtceu:chaotixic_alloy_ring',
            '2x kubejs:uiv_transmission_assembly',
            'kubejs:uiv_precision_drive_mechanism',
            '#gtceu:circuits/uiv',
    ...
    event.recipes.gtceu
        .assembly_line(id('draco_abyssal_turbine_rotor'))
        .itemInputs(
            'gtceu:void_frame',
            'kubejs:uiv_transmission_assembly',
