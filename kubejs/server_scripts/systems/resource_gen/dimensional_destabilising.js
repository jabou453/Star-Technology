ServerEvents.recipes((event) => {
    ...
    event.recipes.gtceu
        .dimensional_destabiliser(id('naquadah_mining'))
        .itemInputs('kubejs:nether_star_shard')
        .inputFluids('gtceu:pcb_coolant 8000')
        .itemOutputs('20x gtceu:raw_naquadah')
    ...
    event.recipes.gtceu
        .assembler(id('dimensional_destabiliser'))
        .itemInputs(
            'gtceu:luv_machine_hull',
            '2x #gtceu:circuits/luv',
            '4x gtceu:double_pure_netherite_plate',
            '2x gtceu:ruridit_gear'
        )
