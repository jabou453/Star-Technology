ServerEvents.recipes(event => {
    ...
    DracoQMD('diode_nt', 'diode', 24, ['2x gtceu:silicon_carbide_over_bismuth_tritelluride_dust', '1x gtceu:neutronium_chip', '8x gtceu:fine_stellarium_wire'], 288, 156);
    DracoQMD('diode_dr', 'diode', 32, ['2x gtceu:silicon_carbide_over_bismuth_tritelluride_dust', '1x gtceu:draco_chip', '8x gtceu:fine_stellarium_wire'], 288, 180);

    // === Material List Loader ===    
        const materialList = (Tier,Tier1,Tier2,Primary,Support,Material,RubberR,RubberF,Plastic,WireTypeComputational,WireTypeMechanical,CableType,GlassType,CatalystType,PrimaryMagnet,SecondaryMagnet,Fluid,VoltageCoil,eut,Scaler,Coolant,SuperConductor,cwu) => {
    ...
    // === Component Parts ===
        ...
        componentParts('computational_matrix', [`gtceu:${Primary}_frame`, `2x #gtceu:circuits/${Tier}`, `4x #gtceu:circuits/${Tier1}`, `6x #gtceu:circuits/${Tier2}`, `4x gtceu:fine_${WireTypeComputational}_wire`, `${2*(2**Scaler)}x kubejs:qram_chip`],
            [`gtceu:sterilized_growth_medium ${250+Scaler*250}`, `gtceu:indium_tin_lead_cadmium_soldering_alloy ${72+Scaler*72}`], 700);
        ...
        componentParts('transmission_assembly', [`gtceu:${Primary}_frame`, `gtceu:${Tier1}_electric_motor`, `2x gtceu:${Primary}_rod`, `2x gtceu:${Primary}_ring`, `8x gtceu:${Primary}_round`, `64x gtceu:fine_${WireTypeMechanical}_wire`],
            [`gtceu:lubricant ${250+Scaler*250}`], 400);
        ...
        componentParts('precision_drive_mechanism', [`gtceu:${Primary}_frame`, `gtceu:${Tier1}_electric_motor`, `#gtceu:circuits/${Tier1}`, `gtceu:${Support}_gear`, `gtceu:small_${Primary}_gear`, `8x gtceu:${Primary}_round`],
            [`gtceu:lubricant ${250+Scaler*250}`, `gtceu:${RubberF} 1728`], 600);
        ...
        componentParts('microfluidic_flow_valve', [`gtceu:${Tier1}_fluid_regulator`, `gtceu:${Material}_small_fluid_pipe`, `2x gtceu:${Primary}_plate`, `6x gtceu:${Primary}_round`, `4x gtceu:${RubberR}_ring`, `6x gtceu:${Primary}_ring`],
            [`gtceu:${Plastic} ${396+Scaler*36}`], 400);
        ...
        componentParts('super_magnetic_core', [`gtceu:long_magnetic_${PrimaryMagnet}_rod`, `2x gtceu:magnetic_${SecondaryMagnet}_rod`, `3x gtceu:${Primary}_rod`, `24x gtceu:fine_${WireTypeMechanical}_wire`, `2x gtceu:${Tier1}_tiny_fluid_pipe`],
            [`gtceu:${Coolant} 2500`], 500);
        
        componentParts('catalyst_core', [`4x gtceu:long_${Primary}_rod`, `gtceu:${GlassType}`, `gtceu:${CatalystType}`, `32x gtceu:fine_${SuperConductor}_wire`, `gtceu:${Tier1}_emitter`, `4x gtceu:${Support}_ring`],
            [`gtceu:${Fluid} 576`], 800);
        
        componentParts('high_strength_panel', [`2x gtceu:double_${Primary}_plate`, `#gtceu:circuits/${Tier}`, `8x gtceu:${Support}_screw`],
            [`gtceu:${Material} 576`, `gtceu:${Plastic} ${396+Scaler*36}`], 300);
    ...
    // === Components ===
        ...
        components('robot_arm', [`4x gtceu:long_${Primary}_rod`, `kubejs:${Tier}_precision_drive_mechanism`, `2x kubejs:${Tier}_transmission_assembly`, `2x gtceu:${Tier}_electric_motor`, `gtceu:${Tier}_electric_piston`, `2x kubejs:${Tier}_computational_matrix`, `2x kubejs:${Tier}_micropower_router`],
