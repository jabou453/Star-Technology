...
ServerEvents.recipes(event => {
    ...
    SteamMachine('hp_steam_blast_furnace',['gtceu:tin_alloy_small_fluid_pipe','gtceu:steel_ring','gtceu:tin_alloy_small_fluid_pipe','gtceu:tin_alloy_small_fluid_pipe','gtceu:hp_steam_furnace','gtceu:tin_alloy_small_fluid_pipe','gtceu:tin_alloy_small_fluid_pipe','gtceu:steel_plate','gtceu:tin_alloy_small_fluid_pipe']);
    ...
    SteamMachine('steam_forge',['kubejs:high_steam_machine_casing','gtceu:small_wrought_iron_gear','kubejs:high_steam_machine_casing','gtceu:steel_firebox_casing','gtceu:hp_steam_blast_furnace','gtceu:steel_firebox_casing','kubejs:high_steam_machine_casing','gtceu:tin_alloy_large_fluid_pipe','kubejs:high_steam_machine_casing']);
