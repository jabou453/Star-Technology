...
ServerEvents.recipes((event) => {
    ...
    const toRemoveOutput = [
        ...
        'createdieselgenerators:oil_detector',
        ...
        'createdieselgenerators:asphalt',
        ...
        'exmachinis:item_buffer',
        'exnihilosequentia:mechanical_sieve',
        'exnihilosequentia:mechanical_hammer',
        'systeams:frost_boiler',
        'exnihilosequentia:golden_mesh',
        'minecraft:mycelium',
        'thermal:gunpowder_4',
        'thermal:dirt_crafting',
        '#thermal:rockwool',
        'create:brass_block',
        'create:zinc_block',
    ...
    const toRemoveId = [
        ...
        'gtceu:macerator/macerate_sculk',
        'thermal:gunpowder_4',
        'gtceu:shaped/block_compress_marble',
        'gtceu:shapeless/block_decompress_marble',
        'createdieselgenerators:basin_fermenting/golden_apple',
        'gtceu:arc_furnace/arc_mega_vacuum_freezer',
        'gtceu:macerator/macerate_mega_vacuum_freezer',
        'gtceu:arc_furnace/arc_mega_blast_furnace',
        'gtceu:macerator/macerate_mega_blast_furnace',
        'gtceu:coke_oven/coal_to_coke',
        'gtceu:coke_oven/coal_to_coke_block',
        'gtceu:large_chemical_reactor/iodine',
        'gtceu:chemical_reactor/iodine',
        'gtceu:autoclave/raw_crystal_chip_from_part_bacterial_sludge',
        'gtceu:autoclave/raw_crystal_chip_from_part_mutagen',
        'gtceu:autoclave/raw_crystal_chip_olivine',
        ...
        'gtceu:macerator/test',
        'gtceu:rock_breaker/blackstone',
    ];
