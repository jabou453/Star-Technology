...
ServerEvents.recipes((event) => {
    ...
    [
        ...
        event.recipes.gtceu
            .alloy_blast_smelter(id(`${abs.metal}_steel`))
        ...
        event.recipes.gtceu
            .alloy_blast_smelter(id(`${abs.metal}_steel_gas`))
            .itemInputs(`ae2:${abs.metal}_dust`, '2x gtceu:steel_dust')
    ...
    ['gold', 'certus_quartz'].forEach((mat) => {
        event.recipes.gtceu
            .mixer(id(`netherite_${mat}_skystone_alloy`))
            .itemInputs(
                '4x gtceu:netherite_dust',
                '2x gtceu:diamond_skystone_alloy_dust',
                `gtceu:${mat}_skystone_alloy_dust`
            )
    ...
    [
        ...
        event.recipes.gtceu
            .mixer(id(`${type.material}_skystone_alloy`))
        ...
        event.recipes.gtceu
            .alloy_blast_smelter(id(`${type.material}_skystone_alloy`))
            .itemInputs(`2x gtceu:${type.material}_dust`)
            .inputFluids('gtceu:skystone 144')
        ...
        event.recipes.gtceu
            .alloy_blast_smelter(id(`${type.material}_skystone_alloy_gas`))
            .itemInputs(`2x gtceu:${type.material}_dust`)
        ...
        event.recipes.gtceu
            .forming_press(id(`${type.circuit}_press`))
        ...
        event.recipes.gtceu
            .forming_press(id(`printed_${type.circuit}_processor`))
    ...
    event.recipes.gtceu
        .forming_press(id('silicon_press'))
    ...
    event.recipes.gtceu
        .forming_press(id('printed_silicon_processor'))
    ...
    [
        ...
        event.recipes.gtceu
            .me_assembler(id(`${tier.type}_core`))
    ...
    event.replaceInput(
        ...
        'gtceu:diamond_skystone_alloy_plate'
    );
});
