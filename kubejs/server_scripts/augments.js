...
ServerEvents.recipes(event => {
    ...
    // Upgrade augments
    [
        {tier: 'lv', plate: 'invar', glass: '_extra:soul_infused', gear: 'bronze', fluid: 'gtceu:tin 720', Mod: 6},
        {tier: 'mv', plate: 'electrum', glass: ':signalum', gear: 'steel', fluid: 'gtceu:redstone 720', Mod: 12},
        {tier: 'hv', plate: 'lumium', glass: ':lumium', gear: 'aluminium', fluid: 'gtceu:glowstone 720', Mod: 24},
        {tier: 'ev', plate: 'soul_infused', glass: ':enderium', gear: 'stainless_steel', fluid: 'thermal:ender 750', Mod: 48}
    ].forEach(tier => {
    ...
    event.recipes.gtceu.assembler(id('lv_arc_augment'))
        ...
        .itemOutputs(Item.of('kubejs:lv_arc_kit', '{AugmentData:{Type: Dynamo, DynamoEnergy:0.67f, DynamoPower:0.5f}}'))
        .duration(600)
        .EUt(28);
    ...
    // ARC's and MCI's
    [
        {tier: 'mv', last_tier: 'lv', gear: 'lumium', glass: 'signalum', DynEA: 0.5, DynP: 1, DynEM: 1.32, energy: 'mv'},
        {tier: 'hv', last_tier: 'mv', gear: 'enderium', glass: 'lumium', DynEA: 0.33, DynP: 2, DynEM: 1.58, energy: 'hv'},
        {tier: 'ev', last_tier: 'hv', gear: 'shellite', glass: 'enderium', DynEA: 0.25, DynP: 3, DynEM: 1.9, energy: 'ev'}
    ].forEach(tier=> {
